...
EXTERNC int     SEGGER_RTT_Read             (unsigned BufferIndex,       char* pBuffer, unsigned BufferSize);
EXTERNC int     SEGGER_RTT_Write            (unsigned BufferIndex, const char* pBuffer, unsigned NumBytes);
EXTERNC int     SEGGER_RTT_WriteString      (unsigned BufferIndex, const char* s);

EXTERNC int     SEGGER_RTT_GetKey           (void);
EXTERNC int     SEGGER_RTT_WaitKey          (void);
EXTERNC int     SEGGER_RTT_HasKey           (void);
...
**********************************************************************
*/
EXTERNC int SEGGER_RTT_printf(unsigned BufferIndex, const char * sFormat, ...);
